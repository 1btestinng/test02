...
export default function BoycottExplorer({entries}:{entries:BoycottEntry[]}){
  ...
  const filtered=useMemo(()=>{
    ...
    return [...result].sort((a,b)=>sort==='company'?a.company.localeCompare(b.company):sort==='category'?categoryLabel(a.category).localeCompare(categoryLabel(b.category)):0);
