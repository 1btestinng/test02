...
const sections=Object.keys(SECTION_CONTENT).filter(section=>section!=='boycott'&&section!=='markets');
...
export default async function SectionPage({params}:{params:Promise<{section:string}>}){const {section}=await params;if(!SECTION_CONTENT[section])notFound();return <NorthAfricaSectionPage section={section}/>}
